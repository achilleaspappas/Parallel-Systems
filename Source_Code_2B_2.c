...
int main(int argc, char *argv[])
{
    ...
    // Copy the output data from the host to the device
    ...
    cudaMemcpy(d_tmp, tmp, NX*sizeof(double), cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(y, d_y, NY*sizeof(double), cudaMemcpyDeviceToHost);
